...
class Document(models.Model):
    ...
    user_id = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Автор документа')
...
class DocumentField(models.Model):
    document_id = models.ForeignKey(Document, on_delete=models.CASCADE, verbose_name='Документ')
